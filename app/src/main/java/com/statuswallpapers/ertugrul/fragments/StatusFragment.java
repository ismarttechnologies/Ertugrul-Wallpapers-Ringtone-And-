...
import com.statuswallpapers.ertugrul.BuildConfig;
import com.statuswallpapers.ertugrul.R;
import com.statuswallpapers.ertugrul.adapters.StatusAdapter;
import com.statuswallpapers.ertugrul.model.PageViewModel;
import com.statuswallpapers.ertugrul.model.Status;
...
//        });
        ...
        progress_bar.setRimColor(getResources().getColor(R.color.grey));
        ...
        progress_bar.setTextSize(27);
        progress_bar.setRimWidth(10);
        progress_bar.setBarWidth(9);
...
//                progress_bar.setSpinSpeed(progress);
                ...
                if (progress==100) {
                    ...
                    progress_bar.setValueAnimated(0);
        ...
        fetch.enqueue(request, new Func<Request>() {
            ...
            public void call(@NotNull Request result) {
                ...
                Toast.makeText(getContext(), "Downloading and Sharing Video...", Toast.LENGTH_SHORT).show();
