package com.statuswallpapers.ertugrul.fragments;
...
import com.statuswallpapers.ertugrul.adapters.RingtoneAdapter;
import com.statuswallpapers.ertugrul.model.PageViewModel;
import com.statuswallpapers.ertugrul.model.Ringtone;
import com.statuswallpapers.ertugrul.utilities.OkhttpUtilities;
...
//                String err =  error.getHttpResponse().getErrorResponse();
                Toast.makeText(getContext(), "Downloading error, Please check your internet", Toast.LENGTH_SHORT).show();
            }
        });
...
//        showProgressDialog(getResources().getString(R.string.loading));
        ...
        final com.squareup.okhttp.Request request = new com.squareup.okhttp.Request.Builder()
                .url("http://test.perfactcode.com/api/media/getAudio")
                .get()
                .build();
...
//                                    dataList.add(new Ringtone(data_array.getJSONObject(i).optString("Id"), name[0], "http://test.perfactcode.com/Audio/Audio2.mp3" , data_array.getJSONObject(i).optString("Download")));
...
//        showProgressDialog(getResources().getString(R.string.loading));
        ...
        final OkHttpClient okHttpClient= OkhttpUtilities.getTrustedHttpClient(new OkHttpClient());
        final com.squareup.okhttp.Request request = new com.squareup.okhttp.Request.Builder()
                .url("http://111.88.244.77/api/media/Download")
                .put(formBody)
                .build();
